...
// Ubicación: erp.js -> Componente Inicial Saneado para Herencia Limpia
// =========================================================================
import { Home } from './home.js';

// Inicialización directa e indestructible en el objeto de la ventana global de Electron
window.ErpModulo = {
    // 📊 CORE MEMORY SOTO SYSTEM: El estado del negocio centraliza el histórico en la RAM
    state: {
        movimientosDiarios: [], 
    ...
    // Validador de consistencia antes de inicializar los listeners de la suite
    verificarEstadoSalud: function() {
        return "OK";
    }
};

// Vinculamos una referencia de conveniencia local para sostener los métodos continuos

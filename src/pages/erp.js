...
window.ErpModulo.render = function() {
    ...
    // Enganchamos el nodo físico de la tarjeta de tus componentes que vive arriba
    if (typeof erpPanel !== 'undefined' && erpPanel !== null) {
        section.appendChild(erpPanel);
        console.log("📦 [SOTO CORE]: Tarjeta de componentes contables acoplada de forma nativa.");
    }
...
// Mapeamos una constante de resguardo idéntica para cumplir de forma obligatoria con Vite
const ErpModulo = window.ErpModulo;

// 📡 ENLAZADO FINAL HOMOLOGADO PARA ELECTRON Y VITE (LÍNEAS FINALES ESTRICTAS)
export { ErpModulo };
